...
const Login = () => {
  ...
  <div className="relative mx-4 mb-4 grid h-28 place-items-center rounded-xl bg-gradient-to-tr from-green-700 to-green-400  text-white shadow-lg shadow-green-500">
  ...
  <div className="p-6 pt-0">
    ...
    <p className="mt-6 flex justify-center font-sans text-sm font-light leading-normal text-inherit antialiased">
      ...
      <Link to="/register"
        className="ml-1 block font-sans text-sm font-bold leading-normal text-green-700 antialiased"
      >
        Register
      </Link>
    </p>
